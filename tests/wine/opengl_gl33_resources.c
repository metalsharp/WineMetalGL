...
int main(void)
{
    ...
    PFNGLBUFFERDATAPROC buffer_data; PFNGLBUFFERSTORAGEPROC buffer_storage; PFNGLGETBUFFERPARAMETERIVPROC get_buffer_parameter; PFNGLMAPBUFFERRANGEPROC map_buffer_range; PFNGLFLUSHMAPPEDBUFFERRANGEPROC flush_mapped_buffer_range; PFNGLUNMAPBUFFERPROC unmap_buffer; PFNGLGETBUFFERSUBDATAPROC get_buffer_sub_data;
