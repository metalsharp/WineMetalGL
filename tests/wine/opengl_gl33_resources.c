...
int main(void)
{
    ...
    PFNGLBUFFERDATAPROC buffer_data; PFNGLBUFFERSTORAGEPROC buffer_storage; PFNGLGETBUFFERPARAMETERIVPROC get_buffer_parameter; PFNGLMAPBUFFERRANGEPROC map_buffer_range; PFNGLUNMAPBUFFERPROC unmap_buffer; PFNGLGETBUFFERSUBDATAPROC get_buffer_sub_data;
    ...
    LOAD(PFNGLBUFFERDATAPROC, buffer_data, "glBufferData"); LOAD(PFNGLBUFFERSTORAGEPROC, buffer_storage, "glBufferStorage"); LOAD(PFNGLGETBUFFERPARAMETERIVPROC, get_buffer_parameter, "glGetBufferParameteriv"); LOAD(PFNGLMAPBUFFERRANGEPROC,map_buffer_range,"glMapBufferRange"); LOAD(PFNGLUNMAPBUFFERPROC,unmap_buffer,"glUnmapBuffer"); LOAD(PFNGLGETBUFFERSUBDATAPROC, get_buffer_sub_data, "glGetBufferSubData");
