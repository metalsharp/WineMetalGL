...
typedef void (WINAPI *PFNGLBUFFERDATAPROC)(GLenum, intptr_t, const void *, GLenum); typedef void*(WINAPI*PFNGLMAPBUFFERRANGEPROC)(GLenum,intptr_t,intptr_t,GLbitfield); typedef GLboolean(WINAPI*PFNGLUNMAPBUFFERPROC)(GLenum); typedef void (WINAPI *PFNGLGETBUFFERSUBDATAPROC)(GLenum,intptr_t,intptr_t,void*);
...
int main(void)
{
    ...
    PFNGLBUFFERDATAPROC buffer_data; PFNGLMAPBUFFERRANGEPROC map_buffer_range; PFNGLUNMAPBUFFERPROC unmap_buffer; PFNGLGETBUFFERSUBDATAPROC get_buffer_sub_data;
    ...
    LOAD(PFNGLBUFFERDATAPROC, buffer_data, "glBufferData"); LOAD(PFNGLMAPBUFFERRANGEPROC,map_buffer_range,"glMapBufferRange"); LOAD(PFNGLUNMAPBUFFERPROC,unmap_buffer,"glUnmapBuffer"); LOAD(PFNGLGETBUFFERSUBDATAPROC, get_buffer_sub_data, "glGetBufferSubData");
