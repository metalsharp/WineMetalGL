...
uint64_t GLMetalRenderer::createTexture1DArrayFormat(uint32_t width, uint32_t layers, uint32_t glInternalFormat, const void* data) {
    ...
    const MTLPixelFormat format = normalized16 ? MTLPixelFormatRGBA16Float : glInternalFormat == 0x822D ? MTLPixelFormatR16Float : glInternalFormat == 0x822E ? MTLPixelFormatR32Float : glInternalFormat == 0x822F ? MTLPixelFormatRG16Float : glInternalFormat == 0x8230 ? MTLPixelFormatRG32Float : glInternalFormat == 0x881B ? MTLPixelFormatRGBA16Float : glInternalFormat == 0x8815 ? MTLPixelFormatRGBA32Float : glInternalFormat == 0x881A ? MTLPixelFormatRGBA16Float : glInternalFormat == 0x8814 ? MTLPixelFormatRGBA32Float : glInternalFormat == 0x8231 ? MTLPixelFormatR8Sint : glInternalFormat == 0x8232 ? MTLPixelFormatR8Uint : glInternalFormat == 0x8233 ? MTLPixelFormatR16Sint : glInternalFormat == 0x8234 ? MTLPixelFormatR16Uint : glInternalFormat == 0x8235 ? MTLPixelFormatR32Sint : glInternalFormat == 0x8236 ? MTLPixelFormatR32Uint : glInternalFormat == 0x8237 ? MTLPixelFormatRG8Sint : glInternalFormat == 0x8238 ? MTLPixelFormatRG8Uint : glInternalFormat == 0x8239 ? MTLPixelFormatRG16Sint : glInternalFormat == 0x823A ? MTLPixelFormatRG16Uint : glInternalFormat == 0x823B ? MTLPixelFormatRG32Sint : glInternalFormat == 0x823C ? MTLPixelFormatRG32Uint : glInternalFormat == 0x8D8E || glInternalFormat == 0x8D8F ? MTLPixelFormatRGBA8Sint : glInternalFormat == 0x8D7C || glInternalFormat == 0x8D7D ? MTLPixelFormatRGBA8Uint : glInternalFormat == 0x8D88 || glInternalFormat == 0x8D89 ? MTLPixelFormatRGBA16Sint : glInternalFormat == 0x8D76 || glInternalFormat == 0x8D77 ? MTLPixelFormatRGBA16Uint : glInternalFormat == 0x8D82 || glInternalFormat == 0x8D83 ? MTLPixelFormatRGBA32Sint : glInternalFormat == 0x8D70 || glInternalFormat == 0x8D71 ? MTLPixelFormatRGBA32Uint : MTLPixelFormatBGRA8Unorm;
    const size_t bpp = format == MTLPixelFormatR8Sint || format == MTLPixelFormatR8Uint ? 1 : format == MTLPixelFormatRG8Sint || format == MTLPixelFormatRG8Uint ? 2 : format == MTLPixelFormatR16Float || format == MTLPixelFormatR16Sint || format == MTLPixelFormatR16Uint ? 2 : format == MTLPixelFormatRG16Float || format == MTLPixelFormatRG16Sint || format == MTLPixelFormatRG16Uint ? 4 : format == MTLPixelFormatR32Float || format == MTLPixelFormatR32Sint || format == MTLPixelFormatR32Uint ? 4 : format == MTLPixelFormatRG32Float || format == MTLPixelFormatRG32Sint || format == MTLPixelFormatRG32Uint ? 8 : format == MTLPixelFormatRGBA8Sint || format == MTLPixelFormatRGBA8Uint ? 4 : format == MTLPixelFormatRGBA16Float || format == MTLPixelFormatRGBA16Sint || format == MTLPixelFormatRGBA16Uint ? 8 : format == MTLPixelFormatRGBA32Float || format == MTLPixelFormatRGBA32Sint || format == MTLPixelFormatRGBA32Uint ? 16 : 4;
