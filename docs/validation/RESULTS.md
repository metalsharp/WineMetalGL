...
- Uniform-buffer object binding/range offsets, multi-buffer base binding, bounded buffer mapping, immutable buffer-storage allocation and storage-flag reflection, persistent/coherent flags with WoW64 low-address copy/flush emulation, and uniform-block name/size reflection.
