...
- Uniform-buffer object binding/range offsets, multi-buffer base binding, bounded buffer mapping, immutable buffer-storage allocation and storage-flag reflection, and uniform-block name/size reflection.
